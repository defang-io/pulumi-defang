...
interface IFabricControllerService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  tail: grpc.MethodDefinition<v1_fabric_pb.Void, v1_fabric_pb.LogEntry>;
  update: grpc.MethodDefinition<v1_fabric_pb.Service, v1_fabric_pb.Service>;
  get: grpc.MethodDefinition<v1_fabric_pb.Void, v1_fabric_pb.Service>;
  delete: grpc.MethodDefinition<v1_fabric_pb.Service, v1_fabric_pb.Void>;
...
export interface IFabricControllerServer extends grpc.UntypedServiceImplementation {
  ...
  tail: grpc.handleServerStreamingCall<v1_fabric_pb.Void, v1_fabric_pb.LogEntry>;
  update: grpc.handleUnaryCall<v1_fabric_pb.Service, v1_fabric_pb.Service>;
  get: grpc.handleUnaryCall<v1_fabric_pb.Void, v1_fabric_pb.Service>;
  delete: grpc.handleUnaryCall<v1_fabric_pb.Service, v1_fabric_pb.Void>;
...
export class FabricControllerClient extends grpc.Client {
  ...
  tail(argument: v1_fabric_pb.Void, metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientReadableStream<v1_fabric_pb.LogEntry>;
  tail(argument: v1_fabric_pb.Void, metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientReadableStream<v1_fabric_pb.LogEntry>;
  ...
  get(argument: v1_fabric_pb.Void, callback: grpc.requestCallback<v1_fabric_pb.Service>): grpc.ClientUnaryCall;
  get(argument: v1_fabric_pb.Void, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.Service>): grpc.ClientUnaryCall;
  get(argument: v1_fabric_pb.Void, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.Service>): grpc.ClientUnaryCall;
  delete(argument: v1_fabric_pb.Service, callback: grpc.requestCallback<v1_fabric_pb.Void>): grpc.ClientUnaryCall;
  delete(argument: v1_fabric_pb.Service, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.Void>): grpc.ClientUnaryCall;
  delete(argument: v1_fabric_pb.Service, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.Void>): grpc.ClientUnaryCall;
