...
interface IFabricControllerService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  listSecrets: grpc.MethodDefinition<v1_fabric_pb.Void, v1_fabric_pb.Secrets>;
...
export interface IFabricControllerServer extends grpc.UntypedServiceImplementation {
  ...
  listSecrets: grpc.handleUnaryCall<v1_fabric_pb.Void, v1_fabric_pb.Secrets>;
...
export class FabricControllerClient extends grpc.Client {
  ...
  update(argument: v1_fabric_pb.Service, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.ServiceInfo>): grpc.ClientUnaryCall;
  update(argument: v1_fabric_pb.Service, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.ServiceInfo>): grpc.ClientUnaryCall;
  get(argument: v1_fabric_pb.ServiceID, callback: grpc.requestCallback<v1_fabric_pb.ServiceInfo>): grpc.ClientUnaryCall;
  get(argument: v1_fabric_pb.ServiceID, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.ServiceInfo>): grpc.ClientUnaryCall;
  get(argument: v1_fabric_pb.ServiceID, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.ServiceInfo>): grpc.ClientUnaryCall;
  ...
  listSecrets(argument: v1_fabric_pb.Void, callback: grpc.requestCallback<v1_fabric_pb.Secrets>): grpc.ClientUnaryCall;
  listSecrets(argument: v1_fabric_pb.Void, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.Secrets>): grpc.ClientUnaryCall;
  listSecrets(argument: v1_fabric_pb.Void, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<v1_fabric_pb.Secrets>): grpc.ClientUnaryCall;
